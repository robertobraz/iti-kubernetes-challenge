...
| Dashboard       | Descrição                    | Métricas Monitoradas             | Status             |
| --------------- | ---------------------------- | -------------------------------- | ------------------ |
| Pods Metrics    | Monitora os pods do app      | CPU, Memória, Número de réplicas | Funcional          |
| HPA Dashboard   | Monitora HPA da aplicação    | CPU Utilization, Pods min/max    | Funcional          |
| App Performance | Métricas da aplicação Kotlin | Latência, Erros, Requests/seg    | Em desenvolvimento |

> Links diretos para os dashboards podem ser adicionados para facilitar o acesso.
